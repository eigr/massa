defmodule MassaProxy.Runtime.Wasm.Server.Dispatcher do
  @moduledoc """
  This module is the entrypoint of all gRPC requests for all protocols
  """
  require Logger
  alias MassaProxy.Runtime.Wasm.Protocol.Action.Handler, as: ActionHandler
  alias MassaProxy.Runtime.Wasm.Protocol.EventSourced.Handler, as: EventSourcedHandler
